...
class Layout():
    def __init__(self, window, main_window):
        ...
        self.b1 = tk.Button(self.control_frame, 
                           activebackground='black', 
                           activeforeground='red', 
                           bg='red', 
                           fg='white', 
                           text="Start Detection", 
                           height=int(screen_height/80), 
                           width=int(screen_width/20), 
                           border=3,
                           command=self.toggle_detection)
        
        # Report False Positive Button
        self.b2 = tk.Button(self.control_frame, 
                           activebackground='black', 
        ...
        self.b3 = tk.Button(self.control_frame, 
                           text="Save Clip", 
                           activebackground='black', 
    ...
    def report_false_positive(self):
        ...
        response = messagebox.askyesno("Report False Positive", 
    ...
    def save_clip(self):
        ...
        if hasattr(self.main_window, 'recent_frames') and self.main_window.recent_frames:
            try:
                ...
                # Save last 10 seconds of footage
...
class MainWindow():
    def __init__(self, window, cap):
        ...
        self.interval = 30  # ms - faster updates for real-time feel
        ...
        # Detection status
        self.detection_status = tk.Label(self.info_panel, 
        ...
        self.current_detection = tk.Label(self.info_panel,
        ...
        # Detection history
        self.history_label = tk.Label(self.info_panel,
                                    text="Recent Detections:",
                                    font=('Arial', 10, 'bold'))
        self.history_label.pack(pady=(20, 5))
        
        self.detection_history = tk.Text(self.info_panel,
                                       height=15,
                                       width=35,
                                       font=('Arial', 9))
        ...
        # Motion indicator
        self.motion_indicator = tk.Label(self.info_panel,
                                       text="Motion: None",
                                       font=('Arial', 10),
                                       fg='gray')
    ...
    def update_image(self):
        ...
        try:
            ...
            cv2.putText(display_frame, status_text, (10, self.height - 20), 
    ...
    def _handle_crime_detection(self, crime_type, confidence, frame):
        ...
        cv2.putText(frame, f"CRIME ALERT: {crime_type.upper()}", (10, 35), 
